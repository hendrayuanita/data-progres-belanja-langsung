                ...
                <div class="page-content-wrap">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <form class="form-horizontal" action="<?php echo site_url() ?>/Pengeluaran/Create" method="post" enctype="multipart/form-data"> 
									...
									<div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">                                            
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="pengeluaran_nominal" class="form-control"/>
                                            </div>                                            
									...
									<div class="form-group">                                        
                                        ...
                                        <div class="col-md-6 col-xs-12">
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="pengeluaran_tgl" class="form-control datepicker">                                            
                                            </div>
